...
describe('JwtStrategy', () => {
  ...
  // Solo se agregan las funciones que utiliza la clase
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        JwtStrategy,
        // getRepositoryToken solo se usa para repositorios
  ...
  it('should throw UnauthrorizedException if user is not active', async () => {
    const payload: JwtPayload = { id: '123' };
